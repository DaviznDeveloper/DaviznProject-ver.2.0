                           ...
                           <c:forEach items="${list}" var="n">
	                              ...
	                              <c:choose>
	                              	<c:when test="${n.datatype=='3'}">
	                              		<td><a href="${pageContext.request.contextPath}/personalData/detailPersonalData.dvn?datatype=${n.datatype}&strgseq=${n.strgseq}&dataseq=${n.dataseq}" class="notice-list-title">${n.dataname} 목표가 종료되었습니다.
