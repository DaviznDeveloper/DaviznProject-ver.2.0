							...
							<tbody>
								<c:forEach var="i" items="${rmlist}">
									...
									<tr>
										...
										<td><a data-toggle="modal" data-target="#msg_content">${i.message_title}</a>
											<!-- Modal -->
											<div class="modal fade" id="msg_content" tabindex="-1"
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">${i.message_content}</div>
										...
										<td><a class="btn btn-danger"
											href="${pageContext.request.contextPath}/deleteReceiveMessage.dvn?message_num=${i.message_num}">삭제</a>
										</td>
									</tr>
						...
						<form action="sendMessage.dvn" method="post">
							<table class="table table-responsive">
								<tr>
									...
									<td><se:authentication property="name" var="LoginUser" />
	
										<input type="text" class="form-control" id="receiver"
										name="receiver">
										<div>
											<p id="div_view" style="background-color: white"></p>
										</div> <input type="hidden" name="sender" id="sender"
										value="${LoginUser}"></td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" class="form-control"
										name="message_title"></td>
								</tr>
								<tr>
									<th>내용:</th>
	
									<td><textarea class="form-control"
											style="resize: none; height: 200px;" wrap="soft"
											name="message_content"></textarea></td>
								</tr>
								<tr>
							...
							<tbody>
								<c:forEach var="i" items="${smlist}">
									...
									<tr>
										...
										<td>${i.message_date}</td>
										<td><a class="btn btn-danger"
											href="${pageContext.request.contextPath}/deleteSendMessage.dvn?message_num=${i.message_num}">삭제</a>
										</td>
									</tr>
